_base_ = [
    '../_base_/models/deeplabv3plus.py', '../_base_/datasets/parihaka.py',
...
work_dir = '/parceirosbr/asml/gabriel.gutierrez/segmentation_unicamp/experiments/parihaka/traning/deeplabv3plus/ce/1000'