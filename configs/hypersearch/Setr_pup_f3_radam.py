...
# optimizer
optimizer = dict(type='RAdam', lr=2.7022452649478758e-05, paramwise_cfg=dict(custom_keys={'head': dict(lr_mult=10.0)}))
...
model = dict(
    ...
    backbone=dict(
        img_size=(512, 512),
        drop_rate=0.12386379152949467),
    decode_head=dict(num_classes=num_classes, loss_decode=loss_balanced_h, dropout_ratio=0.022381731709694676),
    ...
    auxiliary_head=[
        dict(
            ...
            dropout_ratio=0.022381731709694676,
            norm_cfg=norm_cfg,
