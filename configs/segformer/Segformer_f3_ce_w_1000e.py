_base_ = [
    '../_base_/models/segformer.py', '../_base_/datasets/f3.py',
...
work_dir = '/parceirosbr/asml/gabriel.gutierrez/segmentation_unicamp/experiments/f3/traning/segformer/ce/1000/'