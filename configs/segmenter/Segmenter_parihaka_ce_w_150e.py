_base_ = [
    '../_base_/models/segmenter.py', '../_base_/datasets/parihaka.py',
...
work_dir = '/parceirosbr/asml/gabriel.gutierrez/segmentation_unicamp/experiments/parihaka/traning/segmenter/ce/150/'